...
const firebaseConfig = {
  apiKey: "AIzaSyB32Kl4TmAlxla77KtZZLHGApEa6Sfs9qw",
  authDomain: "springpad-7fe41.firebaseapp.com",
  projectId: "springpad-7fe41",
  storageBucket: "springpad-7fe41.firebasestorage.app",
  messagingSenderId: "174807560529",
  appId: "1:174807560529:web:7c22a8c76bbeabb9aae370"
};
...
const updateUI = (user) => {
    if (user) {
        ...
        const loginSpan = `<span class="ms-2">${user.displayName || 'Usuário logado'}</span>`;
